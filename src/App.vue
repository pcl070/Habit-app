  ...
  <header>
    ...
    >
      <g id="Meditation">
        ...
        <path d="M218.2157,68.5864a6,6,0,1,0,9.9688-6.68l-8.4961-12.6792a6,6,0,0,0-9.9688,6.68Z" />
      </g>
    </svg>
    <!-- Reset Data Button -->
...
:root {
  ...
  --light-elements-color: linear-gradient(90deg, rgb(181, 174, 218) 4%, rgb(235, 188, 233) 94%);
  --text-color: #000;
...
html.dark {
  ...
  --light-elements-color: linear-gradient(90deg, rgb(15, 15, 15) 4%, rgb(36, 31, 33) 94%);
  --text-color: #fff;
